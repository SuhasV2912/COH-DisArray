...
def sos():
    ...
    kit.sendwhatmsg_instantly(phone_no='+91 9845129593',message=f'This is an SOS from Suhas, this is his latest location https://maps.google.com/?q={latitude},{longitude} ')
